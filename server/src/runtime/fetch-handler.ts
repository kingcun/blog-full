...
const ROOT__POST_PATTERN = /^\/(rss\.xml|atom\.xml|rss\.json|post\.json|post\.xml)$/;
...
function isRootPostRequest(pathname: string) {
  return ROOT__POST_PATTERN.test(pathname);
}
