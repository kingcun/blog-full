...
RSS_DESCRIPTION=<RSS description, defaults to Post from Rin>
```
...
RSS no longer requires any extra Workers route configuration. After deployment, you can access the post endpoints directly.
