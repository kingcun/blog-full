...
import { PostCard, type PostCardProps } from "./post_card";
import { type PostCardVariant } from "./post-card-options";
...
const PREVIEW_PROPS: PostCardProps = {
  id: "preview-post-card",
  title: "A quieter card with stronger hierarchy",
  summary:
    "This preview shows how article lists feel before you save. The image, metadata, and tags all respond to the selected post card style.",
...
export function PostCardPreview({
  ...
  return (
    <SettingsPreviewCard
      ...
      selected={selected}
      onClick={onClick}
      preview={<PostCard {...PREVIEW_PROPS} preview variant={variant} />}
    />
  );
}
