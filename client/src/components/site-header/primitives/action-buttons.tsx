...
import { clearTrendingCache } from "../../trending-sidebar";
  ...
  return (
    <div className={className + " flex flex-row items-center"}>
      <button
        ...
        className={
          plain
            ? "flex aspect-[1] items-center justify-center px-1.5 text-white transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100"
            ...
            {profile.permission ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-amber-600 transition-colors hover:bg-amber-50 dark:text-amber-300 dark:hover:bg-amber-950/30"
                >
