          ...
          <div className="rounded-2xl border border-black/10 bg-w p-5 dark:border-white/10">
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 flex flex-col gap-2">
                ...
                <AdminNavItem href="/admin/import-article" icon="ri-download-cloud-line" label={t("import_article")} />
                <AdminNavItem href="/admin/manage-articles" icon="ri-list-check-2" label={t("manage_articles")} />
