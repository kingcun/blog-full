...
import { PostPage, TOCHeader } from "../page/post";
...
import { ImportArticlePage } from "../page/import-article";
import { ManageArticlesPage } from "../page/manage-articles";
...
export function AppRoutes() {
  ...
  return (
    <Switch>
      ...
      <AdminRoute path="/admin/import-article" requirePermission title={t("import_article")} description={t("admin.import_article_description")}>
        <ImportArticlePage />
      </AdminRoute>

      <AdminRoute path="/admin/manage-articles" requirePermission title={t("manage_articles")} description="Bulk manage and delete articles.">
        <ManageArticlesPage />
      </AdminRoute>
      ...
      <TocRoute path="/post/:id">
        {(params, toc, cleanup) => <PostPage id={params.id || ""} TOC={toc} clean={cleanup} />}
      </TocRoute>

      <TocRoute path="/:alias">
        {(params, toc, cleanup) => <PostPage id={params.alias || ""} TOC={toc} clean={cleanup} />}
      </TocRoute>
