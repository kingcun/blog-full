...
import { normalizePostCardVariant } from "../components/post-card-options";
import { normalizePostLayout } from "../components/post-layout-options";
...
export const SITE_CONFIG_KEYS = {
    ...
    postCardVariant: "post.card_variant",
...
export function useSiteConfig() {
    ...
    return {
        ...
        postLayout: normalizePostLayout(config.get<string>(SITE_CONFIG_KEYS.postLayout) || "list"),
        postCardVariant: normalizePostCardVariant(config.get<string>(SITE_CONFIG_KEYS.postCardVariant) || "default"),
